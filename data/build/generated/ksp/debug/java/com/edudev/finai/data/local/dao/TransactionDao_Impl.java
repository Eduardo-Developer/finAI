...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransactionEntity = new EntityInsertionAdapter<TransactionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`userId`,`amount`,`category`,`description`,`type`,`date`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTransactionEntity = new EntityDeletionOrUpdateAdapter<TransactionEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `transactions` SET `id` = ?,`userId` = ?,`amount` = ?,`category` = ?,`description` = ?,`type` = ?,`date` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteTransaction = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM transactions WHERE userId = ? AND id = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object deleteTransaction(final String userId, final long id,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      ...
      public List<TransactionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TransactionEntity(_tmpId,_tmpUserId,_tmpAmount,_tmpCategory,_tmpDescription,_tmpType,_tmpDate);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllTransactionsOnce(final String userId,
  ...
  @Override
  public Object getTransactionById(final String userId, final long id,
      final Continuation<? super TransactionEntity> $completion) {
    final String _sql = "SELECT * FROM transactions WHERE userId = ? AND id = ?";
      ...
      public TransactionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new TransactionEntity(_tmpId,_tmpUserId,_tmpAmount,_tmpCategory,_tmpDescription,_tmpType,_tmpDate);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getTransactionsByTypeAndDateRange(final String userId, final TransactionType type,
      final Date startDate, final Date endDate,
      final Continuation<? super List<TransactionEntity>> $completion) {
    final String _sql = "SELECT * FROM transactions WHERE userId = ? AND type = ? AND date BETWEEN ? AND ?";
    ...
    _argIndex = 4;
    final Long _tmp_2 = __converters.dateToTimestamp(endDate);
    if (_tmp_2 == null) {
      _statement.bindNull(_argIndex);
    } else {
  ...
  @Override
  public Object getTotalByTypeAndDateRange(final String userId, final TransactionType type,
      final Date startDate, final Date endDate, final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amount) FROM transactions WHERE userId = ? AND type = ? AND date BETWEEN ? AND ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 4);
    int _argIndex = 1;
    _statement.bindString(_argIndex, userId);
    _argIndex = 2;
  ...
  @Override
  public Object getCategorySpendings(final String userId, final TransactionType type,
      final Date startDate, final Date endDate,
      final Continuation<? super List<CategorySpendingResult>> $completion) {
    final String _sql = "SELECT category, SUM(amount) as total FROM transactions WHERE userId = ? AND type = ? AND date BETWEEN ? AND ? GROUP BY category";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 4);
    int _argIndex = 1;
    _statement.bindString(_argIndex, userId);
    _argIndex = 2;
      ...
      public List<CategorySpendingResult> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CategorySpendingResult(_tmpCategory,_tmpTotal);
            _result.add(_item);
          }
          return _result;
        } finally {
