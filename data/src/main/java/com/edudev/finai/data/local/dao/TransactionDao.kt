...
interface TransactionDao {
    ...
    fun getTransactionsByDateRange(userId: String, startDate: Date, endDate: Date): Flow<List<TransactionEntity>>
    ...
    @Query(
        ...
        WHERE userId = :userId AND type = :type AND date BETWEEN :startDate AND :endDate 
        GROUP BY category
        """
    )
    suspend fun getCategorySpendings(userId: String, type: TransactionType, startDate: Date, endDate: Date): List<CategorySpendingResult>
